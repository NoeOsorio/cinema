const movies = [
    {
        ...
        description: "A heartwarming story about a robot named Wall-e who falls in love with another robot while cleaning up Earth.",
        times: [
    ...
    },
    {
        ...
        description: "Spiderman must face his own personal demons while battling powerful villains to protect the city.",
        times: [
            new Date("2022-01-01T14:00:00"),
            new Date("2022-01-01T17:00:00"),
            new Date("2022-01-01T20:00:00"),
    ...
    },
    {
        ...
        description: "The Avengers team up to stop the powerful Thanos from collecting all the Infinity Stones and wiping out half of the universe.",
        times: [
            new Date("2022-01-01T14:00:00"),
            new Date("2022-01-01T17:00:00"),
            new Date("2022-01-01T20:00:00"),
